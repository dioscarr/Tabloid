...
Signals are validated, retained for approximately 25 hours, and capped at 20,000 records. Aggregates include request count, server error count, and average latency. Brain stores no request body, cookie, token, visitor ID, or user identity in telemetry.
