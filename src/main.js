...
<section class="hero"><div><p class="kicker">Neural operating layer</p><h1>Think in<br><span>connections.</span></h1><p class="intro">A spatial control plane for the tools, skills, permissions, and application routes that give Brain its living context.</p><div class="hero-actions"><a href="#tools">Explore capabilities</a><a class="secondary" href="#skills">Browse skills</a></div></div><div class="neural-hero" aria-hidden="true"><svg class="neural-lines" viewBox="0 0 520 430" preserveAspectRatio="xMidYMid meet"><path d="M122 125C170 54 262 47 315 88C392 74 442 142 410 198C454 255 408 344 329 344C271 392 177 367 159 304C87 282 72 190 122 125Z"/><path d="M126 178 224 132 303 167 394 130M107 236 205 214 284 258 409 216M160 302 228 279 317 324 384 282M224 132 205 214 228 279M303 167 284 258 317 324M205 214 303 167M284 258 394 130"/></svg><span class="neural-haze"></span>${[[122,125],[170,92],[224,132],[284,95],[315,88],[394,130],[410,198],[409,216],[384,282],[329,344],[317,324],[228,279],[160,302],[107,236],[126,178],[205,214],[303,167],[284,258]].map(([x,y],index)=>`<i class="neural-node n${index%5}" style="--x:${x/5.2}%;--y:${y/4.3}%;--delay:-${index*.23}s"></i>`).join('')}<span class="neural-caption">Live context field <b>◌</b></span></div><div class="pulse-card"><span class="pulse-orb"><i></i></span><div><small>Brain status</small><strong id="health-score">—</strong><p id="health-copy">Connecting to control plane…</p></div></div></section>
